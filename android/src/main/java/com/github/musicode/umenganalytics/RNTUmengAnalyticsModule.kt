...
class RNTUmengAnalyticsModule(private val reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext), ActivityEventListener {
    ...
    companion object {
        ...
        private var pushModule: RNTUmengAnalyticsModule? = null
    ...
    private var pushAgent = AnalyticsAgent.getInstance(reactContext)
